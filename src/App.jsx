...
function App() {
  ...
  useEffect(() => {
    ...
    map.current.on('load', async () => {
      // Load the icon from the static file in the public directory
      const image = await map.current.loadImage('/pint-glass.svg');
